...
var	mobileMenuTitle = "Menu",					//The title of the mobile menu
	...
	//TWITTER VARIABLE
	twitter_username = "Wedding",				//Replace with your own Twitter username
	...
	map_initial_latitude = 20.1863,			//Google map initial Latitude. If "null", latitude of the first marked will be used
	map_initial_longitude = 85.6223,		//Google map initial Longitude. If "null", longitude of the first marked will be used
